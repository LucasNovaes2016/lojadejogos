<?php
   ...
   if (!isset($_SESSION['id'])) {
    ...
    $array_categories = array(0 => 'Todas', 1 => 'Acao', 2 => 'Aventura', 3 => 'Corrida', 4 => 'Esportes', 5 => 'Tiro', 6 => 'Mundo Aberto', 7 => 'Infantil', 8 => 'RPG', 9 => 'Luta');
    $array_categories[10] = 'Outro'; // key 10 não estava sendo aceita na linha acima
    $array_selected_category = array('','','','','','','','','','','');
    $array_plataforms = array(0 => 'Todas', 1 => 'Playstation 2', 2 => 'Playstation 3', 3 => 'Playstation 4', 4 => 'Xbox', 5 => 'Xbox 360', 6 => 'Xbox One', 7 => 'Game Cube', 8 => 'Nintendo Wii', 9 => 'Nintendo Wii U');
    $array_plataforms[10] = 'Nintendo Switch'; // key 10 não estava sendo aceita na linha acima
